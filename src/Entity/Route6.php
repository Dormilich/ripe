...
/**
 * A route6 object contains routing information for IPv6 address space resources.
 ...
 * System can be specified by using a route6 object for IPv6 addresses.
 *
...
class Route6 extends Entity implements Primary, RouteInterface
{
    ...
    {
        $this->create('route6', Presence::primary_key, Repeat::single);
    ...
    {
        if (preg_match('~^([0-9a-fA-F:/]+)(AS\d+)$~', (string) $handle, $match)) {
            $this->set('route6', $match[1]);
