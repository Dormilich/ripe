...
class InetRtr extends AbstractObject
{
    ...
    {
        $this->define( 'inet-rtr', Attr::MANDATORY, Attr::SINGLE );
        $this->define( 'descr', Attr::OPTIONAL, Attr::MULTIPLE );
        $this->define( 'alias', Attr::OPTIONAL, Attr::MULTIPLE );
        $this->define( 'local-as', Attr::MANDATORY, Attr::SINGLE );
        $this->define( 'ifaddr', Attr::MANDATORY, Attr::MULTIPLE );
        $this->define( 'interface', Attr::OPTIONAL, Attr::MULTIPLE );
        $this->define( 'peer', Attr::OPTIONAL, Attr::MULTIPLE );
        $this->define( 'mp-peer', Attr::OPTIONAL, Attr::MULTIPLE );
